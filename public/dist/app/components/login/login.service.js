...
var LoginService = (function () {
    function LoginService(http, router, sharedService) {
        ...
        this.postUrlPath = '/api/users/authenticate';
        this.logoutUrlPath = '/api/users/logout';
    ...
    LoginService.prototype.login = function (userCred) {
        var _this = this;
        var bodyString = JSON.stringify({ emailAddress: userCred.email, password: userCred.password });
    ...
    LoginService.prototype.logout = function () {
        ...
        return this.http.post(this.logoutUrlPath, {}, options)
            ...
            _this.sharedService.isUserLogged = false;
        }).catch(function (error) { return Rx_1.Observable.throw(error || 'Server error'); }); // catch errors if any
    };
